...
export default function RecordVisitPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // เรียงข้อมูลตาม Column ที่คุณกำหนดเป๊ะๆ
      const dataRow = [
        params.hn,                  // 1. hn
        today,                      // 2. date
  ...
  return (
    <div className="min-h-screen bg-[#FEFCF8] p-6 pb-20 font-sans text-[#2D2A26]">
      ...
      <div className="max-w-3xl mx-auto bg-white border-2 border-[#3D3834] shadow-[8px_8px_0px_0px_#3D3834] p-8">
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
           ...
           <div>
              ...
              <p className="text-[#6B6560] font-medium">HN: {params.hn}</p>
           </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-[#F7F3ED] p-6 border border-[#3D3834]/20 rounded-lg space-y-4">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input 
                        ...
                        className="w-full px-4 py-3 bg-white border-2 border-[#3D3834] focus:border-[#D97736] outline-none font-black text-xl text-center"
                ...
                <div>
                    ...
                    <select name="control_level" value={formData.control_level} onChange={handleChange}
                        className="w-full px-4 py-3 bg-white border-2 border-[#3D3834] outline-none font-bold"
                    >
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="controller" value={formData.controller} onChange={handleChange}
                        className="w-full px-4 py-3 bg-[#F7F3ED] border-2 border-[#3D3834] outline-none"
                    >
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="font-bold w-12 text-right">{formData.adherence}%</span>
                    </div>
                </div>
                <div>
                    ...
                    <input type="text" name="drp" value={formData.drp} onChange={handleChange}
                        className="w-full px-4 py-2 bg-[#F7F3ED] border border-[#3D3834] outline-none"
                    />
                </div>
             </div>
          </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        className="w-full px-4 py-3 bg-white border-2 border-[#3D3834] focus:border-[#D97736] outline-none font-bold text-center"
          ...
          <div className="bg-[#FFF9F0] p-6 border border-[#D97736]/30 rounded-lg space-y-4">
             ...
             <div>
                ...
                <input type="text" name="advice" value={formData.advice} onChange={handleChange}
                    className="w-full px-4 py-2 bg-white border border-[#3D3834] outline-none"
                />
             </div>
             ...
             <div>
                ...
                <textarea name="note" rows={2} value={formData.note} onChange={handleChange}
                    className="w-full px-4 py-2 bg-white border border-[#3D3834] outline-none resize-none"
                />
             </div>
             ...
             <div>
                ...
                <input type="date" name="next_appt" value={formData.next_appt} onChange={handleChange}
                    className="w-full px-4 py-3 bg-white border-2 border-[#3D3834] focus:border-[#D97736] outline-none font-bold"
                />
             </div>
          </div>
